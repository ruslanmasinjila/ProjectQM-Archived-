...
def get_signals():
    ...
    for symbol in symbols:
        ...
        for t in range(len(mt5Timeframe)):
            ...
            fourth_sequence_tail_high   = rates_frame['high'].iloc[fourth_sequence_indices[0]]
            fourth_sequence_tail_low  = rates_frame['low'].iloc[fourth_sequence_indices[0]]
            ...
            first_sequence_head_high   = rates_frame['high'].iloc[first_sequence_indices[-1]]
            first_sequence_head_low    = rates_frame['low'].iloc[first_sequence_indices[-1]]
            ...
            if(first_sequence_is_green and second_sequence_is_red and third_sequence_is_green and fourth_sequence_is_red and fifth_sequence_is_green):
                if((fourth_sequence_lowest_low < second_sequence_lowest_low and 
                    ...
                    if(fifth_sequence_highest_high > third_sequence_highest_high):
                        if(first_sequence_lowest_low > third_sequence_highest_high  and first_sequence_lowest_low > fourth_sequence_highest_high): 
            ...
            if(first_sequence_is_red and second_sequence_is_green and third_sequence_is_red and fourth_sequence_is_green and fifth_sequence_is_red):
                if((fourth_sequence_highest_high > second_sequence_highest_high and 
                    ...
                    if(fifth_sequence_lowest_low < third_sequence_lowest_low):
                        if(first_sequence_highest_high < third_sequence_lowest_low  and first_sequence_highest_high < fourth_sequence_lowest_low): 
